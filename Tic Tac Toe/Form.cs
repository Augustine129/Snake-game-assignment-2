    ...
    public partial class MainForm : Form
    {
        ...
        private void CheckComputerPlay()
        {
            ...
            if (turn.ComputerPlayer)
            {
                ...
                var selected = turn.SelectButton(
                    turn.Equals(playerOne) ? playerTwo : playerOne, buttons);
        ...
        private void CreateGame(Player player1, Player player2)
        {
            ...
            assignNamePlayerOne.Text = player1.PlayersΝame;
            showScorePlayer1.Text = @"0";
            assignNamePlayerTwo.Text = player2.PlayersΝame;
            showScorePlayer2.Text = @"0";
        ...
        private void EndGameWin()
        {
            ...
            MessageBox.Show(turn + @" Well done you won the game!", @"Match");
            ...
            if (turn == playerOne)
                showScorePlayer1.Text = turn.Score.ToString();
            else
                showScorePlayer2.Text = turn.Score.ToString();
        ...
        private void HandleMoves(object sender, EventArgs e)
        {
            ...
            if (button.Text.Length == 0)
            {
                ...
                var state = turn.MakeMove(button, x, y);
        ...
        private void ResetNameLabel1()
        {
            ...
            assignNamePlayerOne.Font = new Font(assignNamePlayerOne.Font, FontStyle.Regular);
            assignNamePlayerOne.ForeColor = Color.Black;
        }

        private void ResetNameLabel2()
        {
            // Reset the name label of player 2 back to it's original state.
            assignNamePlayerTwo.Font = new Font(assignNamePlayerTwo.Font, FontStyle.Regular);
            assignNamePlayerTwo.ForeColor = Color.Black;
        }
        ...
        private void SetTurnPlayer1()
        {
            ...
            assignNamePlayerOne.Font = new Font(assignNamePlayerOne.Font, FontStyle.Bold);
            assignNamePlayerOne.ForeColor = turn.PlayerColour;
        ...
        private void SetTurnPlayer2()
        {
            ...
            assignNamePlayerTwo.Font = new Font(assignNamePlayerTwo.Font, FontStyle.Bold);
            assignNamePlayerTwo.ForeColor = turn.PlayerColour;
